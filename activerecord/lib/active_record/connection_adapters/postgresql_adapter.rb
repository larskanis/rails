...
module ActiveRecord
  ...
  module ConnectionAdapters
    ...
    class PostgreSQLAdapter < AbstractAdapter
      ...
      #
      # This is a very simple hash implementation with a low memory footprint.
      # It takes 8 bytes per entry instead of around 50 of a Hash based one on 64-bit MRI.
      # It depends on String#hash, so that collisions can occur.
      # They have a minor performance impact only, so should be no real issue.
